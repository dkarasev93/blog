...
Фраза `Don’t worry` стоит рядом с признанием `previous faulty version`. Сыщик видел много лондонских сообщений, но редко встречал такое вежливое соседство: «ваш жеттон создан неисправным инструментом, не волнуйтесь, нажмите кнопку».
